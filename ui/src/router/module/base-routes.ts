...
export default [
  ...
  {
    path: '/consul',
    redirect: '/consul/list',
    component: BasicLayout,
    children: [
      {
        path: '/consul/list',
        name: 'consul',
        component: () => import('../../views/consul/list.vue'),
        meta: { title: 'Consul配置列表', requireAuth: true, affix: true, closable: false },
      },
      {
        path: '/consul/bk',
        component: () => import('../../views/consul/bk.vue'),
      }
      // , {
      //   path: 'consul/preview',
    ...
    path: '/ocelotglobal',
    redirect: '/ocelot/global',
    component: BasicLayout,
    children: [
      {
        path: '/ocelot/global',
        name: 'global',
        component: () => import('../../views/ocelot/global.vue'),
        meta: { title: '全局配置', requireAuth: true, affix: true },
      },
      {
        path: '/consul/bk',
        component: () => import('../../views/consul/bk.vue'),
    ...
    component: BasicLayout,
    children: [{
      path: '/ocelotrouter/proj',
      component: () => import('../../views/ocelot/proj.vue'),
      meta: { title: '项目列表', requireAuth: true },
    },
    {
      path: '/ocelotrouter/list',
      component: () => import('../../views/ocelot/routerproj.vue'),
      meta: { title: 'Ocelot 路由', requireAuth: true },
    },
    {
      path: '/ocelotrouter/sync',
      component: () => import('../../views/ocelot/projSync.vue'),
      meta: { title: 'Ocelot 同步', requireAuth: true },
    }
    ]
  },
  {
